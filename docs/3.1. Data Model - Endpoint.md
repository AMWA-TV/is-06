...
* `attached_network_device`: The switch's MAC address and its interface alias (ifAlias) which are provided by the switch in the LLDP's mandatory Chassis ID and Port ID parameters
